...
export const floorData = {
    1: {
        ...
        boss: {
            ...
            col: 70,
            icon: '👹',
            drops: { 'kobold_fang': 1.0, 'iron_ore': 0.3, 'basic_sword': 0.05 },
            specialDrop: 'divine_fragment', // First special drop
            skills: [
    ...
    2: {
        ...
        boss: {
            ...
            col: 150,
            icon: '🐂',
            drops: { 'silver_ingot': 0.5, 'iron_sword': 0.05 },
            specialDrop: 'silver_ingot',
            skills: [
