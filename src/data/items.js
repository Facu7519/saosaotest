...
export const baseItems = {
    ...
    'kobold_dagger': { name: 'Daga de Kóbold', icon: '🦴', type: 'weapon', slot: 'weapon', stats: { attack: 11, crit: 0.10 }, levelReq: 3, description: "Daga dentada hecha de colmillo.", rarity: 'Common' },
    ...
    'reinforced_leather': { name: 'Cuero Reforzado', icon: '🥋', type: 'armor', slot: 'armor', stats: { defense: 5, hp: 15 }, levelReq: 3, description: "Cuero endurecido con placas." },
    ...
    // Accesorios
    'heavy_boots': { name: 'Botas Pesadas', icon: '👢', type: 'accessory', slot: 'accessory', stats: { defense: 2 }, levelReq: 2, description: "Botas con punta de hierro." },
...
export const blacksmithRecipes = {
    ...
    'short_sword': { itemId: 'short_sword', materials: { 'iron_ore': 5, 'raw_hide': 2 }, cost: 50, levelReq: 2, chance: 0.95 },
    'heavy_boots': { itemId: 'heavy_boots', materials: { 'raw_hide': 6, 'iron_ore': 2 }, cost: 90, levelReq: 2, chance: 0.95 },
    
    'kobold_dagger': { itemId: 'kobold_dagger', materials: { 'kobold_fang': 3, 'raw_hide': 2 }, cost: 120, levelReq: 3, chance: 0.90 },
    'reinforced_leather': { itemId: 'reinforced_leather', materials: { 'raw_hide': 10, 'iron_ore': 3 }, cost: 150, levelReq: 3, chance: 0.92 },
    ...
    'iron_sword': { itemId: 'iron_sword', materials: { 'iron_ore': 15, 'raw_hide': 5 }, cost: 180, levelReq: 5, chance: 0.90 },
